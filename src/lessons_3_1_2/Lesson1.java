...
public class Lesson1 {
    public static void main(String[] args) {
        ...
        boolean xGTy = x > y;
        System.out.println(xGTy); //it's false
        String name = "Henry";
        String name2 = new String("Henry"); //nonono, not good
        ...
        //NO! We need to use .equals() for objects. == compares the references
        boolean oneAndTwo = rect1.equals(rect2); //does not work as expected because it compares memory addresses
